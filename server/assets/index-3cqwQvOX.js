import { r as reactExports, V as jsxRuntimeExports } from "./server-DaOOXGhY.js";
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex items-center px-6 md:px-16 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 -right-40 w-[500px] h-[500px] rounded-full bg-white/[0.04] blur-[120px]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-6xl mx-auto w-full z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-muted-foreground", children: "01 — Coimbatore, IN" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-px w-16 bg-border" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 font-mono text-[10px] tracking-[0.3em] uppercase text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h1,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Sri" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient italic", children: "Kumaran" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg md:text-xl text-foreground/80 leading-relaxed", children: [
              "A ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif-display italic text-foreground", children: "Java Full Stack Developer" }),
              " building scalable backend systems and cloud-native applications with Spring Boot, Microservices and AWS."
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs uppercase tracking-widest text-muted-foreground space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/40", children: "Focus / " }),
                "Backend"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/40", children: "Stack / " }),
                "Java · Spring · AWS"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/40", children: "Email / " }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:srikumaran@gmail.com", className: "hover:text-foreground transition-colors normal-case tracking-normal", children: "srikumaran@gmail.com" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/40", children: "Phone / " }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919999999999", className: "hover:text-foreground transition-colors", children: "+91 99999 99999" })
              ] })
            ] })
          ]
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 font-mono text-[10px] tracking-[0.3em] uppercase text-muted-foreground/60", children: "Scroll ↓" })
  ] });
}
function Section({
  id: id2,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: id2, className: "relative py-32 px-6 md:px-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 30 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-muted-foreground", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif-display text-5xl md:text-7xl tracking-tight text-gradient", children: title })
        ]
      }
    ),
    children
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "about", label: "01 / About", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Engineering" }),
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "at scale." })
  ] }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-12 gap-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-6 text-lg md:text-xl text-muted-foreground leading-relaxed font-light", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I architect and ship enterprise-grade backend systems — distributed microservices on Spring Boot, event-driven pipelines on AWS, and APIs designed to scale gracefully under load." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "My work lives at the intersection of",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif-display italic text-foreground", children: "clean architecture" }),
        ",",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif-display italic text-foreground", children: "observability" }),
        ", and the small details that separate good software from great software."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5 md:pl-8 md:border-l border-border space-y-8", children: stats.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif-display text-5xl md:text-6xl text-gradient", children: s.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground", children: s.label })
        ]
      },
      s.label
    )) })
...
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "skills", label: "02 / Skills", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Tools of the " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "trade." })
  ] }), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border border-y border-border", children: groups.map((g, gi) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 20 },
      whileInView: { opacity: 1, y: 0 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-1 font-mono text-xs text-muted-foreground pt-1", children: [
          "0",
          gi + 1
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif-display text-3xl md:text-4xl", children: g.title }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-8 flex flex-wrap gap-x-6 gap-y-3 items-center", children: g.skills.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.span,
          {
            initial: { opacity: 0 },
            ...
            children: [
              s,
              i < g.skills.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-6 text-muted-foreground/40", children: "·" })
            ]
          },
          s
        )) })
...
function Experience() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "experience", label: "03 / Experience", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "The " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "journey." })
  ] }), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-px bg-border", children: experience.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 30 },
      whileInView: { opacity: 1, y: 0 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-3 font-mono text-xs uppercase tracking-widest text-muted-foreground", children: e.duration }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif-display text-3xl md:text-4xl leading-tight", children: e.role }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-2", children: e.company })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "md:col-span-5 space-y-3 text-sm md:text-base text-muted-foreground", children: e.points.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3 leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/40 shrink-0", children: "→" }),
...
const projects = [
  {
    ...
    description: "Event-driven file ingestion pipeline processing millions of documents through S3, SQS, and Lambda — metadata persisted to DynamoDB.",
  ...
  },
  {
    ...
    description: "Distributed commerce platform with independent services for catalog, cart, orders, and payments — orchestrated on Kubernetes.",
  ...
  },
  {
    ...
    description: "Secure cloud-native document vault with versioning, role-based access, and global CDN delivery via CloudFront.",
  ...
  },
  {
    ...
    description: "Low-latency notification fan-out system supporting WebSocket, push, and email channels with at-least-once delivery.",
    stack: ["Spring WebFlux", "Kafka", "Redis", "WebSocket", "AWS SNS"],
    year: "2022"
  }
];
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "projects", label: "04 / Selected Work", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Recent " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "projects." })
  ] }), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border border-y border-border", children: projects.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.article,
    {
      initial: { opacity: 0, y: 20 },
      whileInView: { opacity: 1, y: 0 },
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif-display text-3xl md:text-4xl leading-tight group-hover:italic transition-all", children: p.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-muted-foreground mt-2 inline-block", children: p.year })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "md:col-span-5 text-sm md:text-base text-muted-foreground leading-relaxed", children: [
          p.description,
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block mt-3 font-mono text-xs uppercase tracking-wider text-foreground/60", children: p.stack.join(" / ") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2 flex md:justify-end items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-6 h-6 text-muted-foreground group-hover:text-foreground group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" }) })
      ]
    },
    p.title
  )) }) });
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative px-6 md:px-16 pt-32 pb-10 border-t border-border overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 noise opacity-50 pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-6xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 grid md:grid-cols-3 gap-8 pb-16 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground mb-2", children: "Based in" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif-display text-2xl", children: "Coimbatore, India" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground mb-2", children: "Currently" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif-display text-2xl italic", children: "Open to work" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground mb-2", children: "Reach me" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:srikumaran@gmail.com", className: "hover:text-foreground/80 transition-colors block", children: "srikumaran@gmail.com" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919999999999", className: "hover:text-foreground/80 transition-colors block mt-1 font-mono text-sm", children: "+91 99999 99999" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Sri Kumaran V"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Crafted with care · v1.0" })
      ] })
    ] })
  ] });
}
